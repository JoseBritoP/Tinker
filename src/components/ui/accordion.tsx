      ...
      <AccordionPrimitive.Header className="flex">
        ...
        >
          ...
          <span className={`transition-transform duration-200 ${open ? 'rotate-180' : ''}`}>
            <PlusIcon className={`h-7 w-7 shrink-0 text-muted-foreground transition-transform duration-200 ${open ? 'hidden' : ''}`} />
            <MinusIcon className={`h-7 w-7 shrink-0 text-muted-foreground transition-transform duration-200 ${open ? '' : 'hidden'}`} />
          </span>
        </AccordionPrimitive.Trigger>
