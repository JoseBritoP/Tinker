  ...
  return (
    <div className="w-full rounded-[16px] bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]">
      ...
      <div className="mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row lg:justify-center gap-x-[40px]">
        <button aria-label="Try services button" className="py-[16px] px-[32px] bg-white rounded-[4px] text-pink-500 w-fit font-medium hover:bg-gray-100">
          Try for free
        </button>

        <button aria-label="Contact button" className="flex w-full items-center justify-center font-medium gap-x-3 mt-[32px] text-white lg:w-fit lg:mt-0">
          Contact Sales{" "}
          <span>
